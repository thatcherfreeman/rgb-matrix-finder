...
def main() -> None:
    ...
    if args.correct_wb:
        parameters = optimizer.optimize_exp_wb(source_chart, reference_chart, source_gamut, target_gamut, verbose=True)
    else:
        parameters = optimizer.optimize_exp(source_chart, reference_chart, source_gamut, target_gamut, verbose=True)
    ...
    print("Delta-E: ", reference_chart.compute_delta_e(optimizer.chart_pipeline(source_chart, exp, mat, wb).convert_to_xyz(target_gamut.get_conversion_to_xyz()).chromatic_adaptation(target_gamut.white.convert_to_xyz(), color_conversions.STD_A).convert_to_lab(color_conversions.STD_A)))
